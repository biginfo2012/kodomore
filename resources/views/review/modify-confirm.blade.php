...
@section('content')
    ...
    <div class="card">
        <div class="card-header title-background text-small-xs d-flex ">
            ...
            <p><span class="top-title-tag">ログイン</span> マイページ >  クチコミレビュー修正内容確認</p>

        </div>

        <div class="card-body text-title px-2 pb-0">
            <img class="height-4 img-icon mb-1" src="{{asset('img/modify.png')}}"> クチコミレビュー修正内容確認
        </div>
        ...
        <div class="card-body py-1 px-2">
            ...
            <form class="needs-validation" novalidate id="validation_form" action="<?=url('/modify/finish');?>" method="post">
                {{csrf_field()}}
                ...
                <p class="text-title background-dark-blue text-white p-1 mt-3">修正内容確認</p>
                ...
                <div class="card-body news-background" style="margin-left: -0.5rem; margin-right: -0.5rem; !important;">
                    ...
                    <div class="blog-answer rounded p-3" style="background-color: white">
                        <div class="d-flex position-relative mb-1 pb-2" style="border-bottom: 1px solid #ABABAB">
                            ...
                            <div>
                                ...
                                <div class="d-flex">
                                    <p class="text-large-xs">投稿ネーム{{$post_user_name}}</p>
                        ...
                        <p class="text-small"><span style="color: #216887">●</span> 授業の工夫度 {{$rate[1]['rate']}}点</p>
                        <p class="text-small ml-3">{{$rate[1]['rate_text']}}</p>
                        <p class="text-small"><span style="color: #216887">●</span> 全体的な講師の質 {{$rate[2]['rate']}}点</p>
                        <p class="text-small ml-3">{{$rate[2]['rate_text']}}</p>
                        <p class="text-small"><span style="color: #216887">●</span> 保護者との連携充実度 {{$rate[3]['rate']}}点</p>
                        <p class="text-small ml-3">{{$rate[3]['rate_text']}}</p>
                        <p class="text-small"><span style="color: #216887">●</span> いじめ対策 {{$rate[4]['rate']}}点</p>
                        <p class="text-small ml-3">{{$rate[4]['rate_text']}}</p>
                        <p class="text-small"><span style="color: #216887">●</span> 校風の良さ {{$rate[5]['rate']}}点</p>
                        <p class="text-small ml-3">{{$rate[5]['rate_text']}}</p>
                        <p class="text-small"><span style="color: #216887">●</span> 生徒の進路満足度 {{$rate[6]['rate']}}点</p>
                        <p class="text-small ml-3">{{$rate[6]['rate_text']}}</p>
                        <p class="text-small"><span style="color: #216887">●</span> 部活や課外レッスンの充実度 {{$rate[7]['rate']}}点</p>
                        <p class="text-small ml-3">{{$rate[7]['rate_text']}}</p>


                        <p class="text-medium-title pt-2" style="border-top: 2px solid #ABABAB">{{$title}}</p>

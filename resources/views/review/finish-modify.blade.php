...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body py-1 text-center mt-4">
            <p class="text-title-large text-blue-1 p-1" style="font-family: YugoBold !important; color: #FF557E !important;">クチコミレビュー修正内容を<br>
                送信しました｡</p>
            <p class="text-medium-light text-black p-0 my-3">ご協力ありがとうございます｡<br>
                クチコミレビュー項目の反映には審査があります｡<br>
                反映されるまでには時間がかかります｡</p>
        </div>

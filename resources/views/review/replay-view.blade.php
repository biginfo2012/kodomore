...
@section('content')
    ...
    <div class="card">
            ...
            <div class="blog-answer rounded position-relative">
                ...
                <div class="detail">
                    ...
                    <div class="d-flex">
                        ...
                        <div>
                            <p class="text-small-xs-bold">園側からの返事</p>
                            <p class="text-small">{{$replay}}</p>
                        </div>
                    </div>
        ...
        <div class="card-body">
            <form class="needs-validation" name="complete" novalidate id="validation_form" method="post" action="{{url('/replay/finish')}}">
                {{csrf_field()}}
                ...
                <div class="mt-2 custom-control custom-checkbox text-medium-light">
                    ...
                    <label class="custom-control-label text-medium-xs" for="radio_accept"><span class="menu-icon text-decoration" id="privacy">｢お返事ガイドライン｣</span>に同意します｡</label>
                </div>

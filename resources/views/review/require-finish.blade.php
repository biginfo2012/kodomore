...
@section('content')
    ...
    <div class="card">
        <div class="card-header title-background text-small-xs d-flex ">
            ...
            <p><span class="top-title-tag">ログイン </span> > <span id="" class="top-title-tag">マイページ</span> > クチコミレビュー投稿削除申請する</p>
        </div>

        <div class="card-body py-1 text-center mt-4">
            <p class="text-title-large text-blue-1 p-1" style="font-family: YugoBold !important; color: #FF557E !important;">クチコミレビュー投稿削除申請を<br>送信しました｡</p>

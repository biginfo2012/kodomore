<div class="card-body py-3 px-0">
    <p class="text-center text-normal mt-1 mb-3">
            ...
            @if($comment->user_id !== session()->get(SESS_UID))
                <div class="d-flex position-relative my-3">
                    <div class="" style="left: 0;">
                        ...
                        <span class="text-small-xs py-1 px-1 ml-0 help" style="border: 1px solid #666666; border-radius: 5rem"><img class="height-1 img-icon mb-1 mr-1" src="{{asset('img/light.png')}}" style="height: 0.85rem !important;pointer; margin-top:2px" ><label class="mb-0 mr-3" style="cursor: pointer;">役に立った</label><label>{{$comment->help}} </label></span>
                    </div>
                    <div class="position-absolute" style="right: 0">
                        <a class="text-small-xs py-1 px-0 ml-1 forbidden text-3" style="" href="{{url('/warn/admin/'. $comment->id)}}"><img class="height-1 img-icon mb-1 mr-1" src="{{asset('img/forbidden.png')}}" style="height: 0.8rem !important;cursor: pointer; margin-top:2px" >管理者に報告</a></div>
                </div>
            @else
                <div class="post_user my-3">
                    <p class="text-small-xs mt-2"><img class="height-1 img-icon pb-1" src="{{asset('img/circle-star.png')}}" style="height: 1.2rem !important;" >{{$comment->attention}}人が注目した！</p>
                    <p class="text-small-xs mt-1"><img class="height-1 img-icon pb-1 mr-1" src="{{asset('img/light.png')}}" style="height: 1.2rem !important;margin-left: 1px !important;" >{{$comment->help}}人が役に立った</p>

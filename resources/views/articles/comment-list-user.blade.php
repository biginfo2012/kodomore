    ...
    @if(!empty($commentList))
        ...
        <div class="blog-answer rounded position-relative mb-3 px-3" style="border-bottom: 1px solid #ABABAB">
            <div class="d-flex position-relative">
                <div class="mt-0">
                    <p class="text-title-large" style="color: black;">{{$comment->article_title}}</p>
            ...
            <div class="position-relative">
                ...
                <div class="post_user my-3">
                    <p class="text-small-xs mt-2"><img class="height-1 img-icon pb-1" style="height: 0.9rem !important;" src="{{asset('img/circle-star.png')}}">{{$comment->attention}}人が注目した！</p>
                    <p class="text-small-xs mt-2"><img class="height-1 img-icon pb-1 mr-1" style="height: 0.9rem !important;" src="{{asset('img/light.png')}}">{{$comment->help}}人が役に立った</p>

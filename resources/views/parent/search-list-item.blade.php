@if(!empty($gardenList))
    @foreach($gardenList as $index => $garden)
        <div class="card-body school-item py-2 mb-0" style="border-bottom: 1px solid #ABABAB">
            <div class="d-flex">
                <img class="height-2 pb-2 pt-1 img-icon mr-2" src="{{asset('img/doc-disabled.png')}}">
                <img class="height-2 pb-2 pt-1 img-icon mr-2" src="{{asset('img/web-disabled.png')}}">
                <img class="height-2 pb-2 pt-1 img-icon mr-2" src="{{asset('img/message-disabled.png')}}">
                <img class="height-2 pb-2 pt-1 img-icon mr-2" src="{{asset('img/question-disabled.png')}}">
                @if($index == 2)
                    <img class="height-2 pb-2 pt-1 img-icon mr-2" src="{{asset('img/pink-calen.png')}}">
                    <img class="height-2 pb-2 pt-1 img-icon mr-2" src="{{asset('img/favourite.png')}}">
                @else
                    <img class="height-2 pb-2 pt-1 img-icon mr-2" src="{{asset('img/event-disabled.png')}}">
                    <img class="height-2 pb-2 pt-1 img-icon mr-2" src="{{asset('img/favourite-disabled.png')}}">
                @endif
            ...
            <div class="row">
                ...
                <div class="col-8 pl-1">
                    <h6 class="text-truncate text-medium-title mb-1 ml-1"><?=$garden->garden_name;?></h6>
                    <div class="d-flex ">
                        ...
                        @else
                            <p class="text-small px-1" style="width: fit-content; background-color: #FFFFC8; line-height: 1.1;">{{$garden -> status}}</p>
                        @endif
                    </div>
                    <div class="d-flex flex-wrap mt-1">
                        @foreach($garden -> keywordList as $keyword)
                            @if($keyword->keyword_id == '10' || $keyword->keyword_id == '9')
                                <div class="mr-1 mb-1 px-1 text-small rounded rounded-small text-white" style="background-color: #FF557E">
                    ...
                    <p class="text-small-xs float-right" style="color: #8E8E8E">閲覧日 {{$garden->created_at}}</p>
                </div>
            </div>

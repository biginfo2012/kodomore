...
@section('content')
    <div class="card">
        <div class="card-header title-background text-small-xs d-flex ">
            ...
            <p><span class="top-title-tag">ログイン </span> > <span id="move_my_page" class="top-title-tag">マイページ </span> > お気に入り</p>
        </div>

        <div class="card-body text-large-medium-xs py-2 background-white-blue" style="border-bottom: 1px solid #ABABAB">
            <img class="height-2 img-icon py-1" src="{{asset('img/favourite_icon.png')}}"> お気に入り
...
@section('js4event')
    <script language="javascript" type="text/javascript">
        ...
        function getSchoolList(order) {
            ...
            var url = home_path + '/parent/favourite/get-list';
            $.ajax({
                url:url,
                type:'post',
                data: {

...
@section('css4page')
    <style>
        ...
        .message-indicator-top-right {
            ...
            width: 0;
            height: 0;
            border-bottom: 1rem solid #FDDFB1;
        ...
        .triangle-right::after{
            ...
            border: .6em solid black;
            border-color: transparent transparent #FDDFB1 #FDDFB1;
...
@section('content')
    <div class="card">
        <div class="card-header title-background text-small-xs d-flex ">
            ...
            <p><span class="top-title-tag">ログイン </span> > <span id="move_my_page" class="top-title-tag">マイページ </span> > スクールホットライン</p>
        </div>

        <div class="card-body text-large-medium-xs py-2 background-white-blue" style="border-bottom: 1px solid #ABABAB">
            <img class="height-2 img-icon py-1" src="{{asset('img/hot-line-list.png')}}"> スクールホットライン
            ...
            <div class="card-body news-background p-2">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-8 pl-1">
                        <div class="text-normal p-2 rounded triangle-right" style="background-color: #FDDFB1; margin-right: 15px;">

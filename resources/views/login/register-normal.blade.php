...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body py-1">
            <p class="text-title background-dark-blue text-white p-1">その他一般(プロ)の方</p>
            <form class="needs-validation" novalidate id="register_form" action="<?=url('/register/normal/confirm');?>" method="post">
                {{csrf_field()}}
                ...
                <input  class="mt-1 form-control text-small require"   name="job" required>
...
{{--                <input  class="mt-1 form-control text-small require"  type="date" name="date" >--}}
                ...
                <div class="mt-1 d-flex require justify-content-center">
                    <input  class="form-control text-small   w-50" size="10" maxlength="8" onKeyUp="AjaxZip3.zip2addr(this,'','city','address');" placeholder="郵便番号(例：1234567)" name="post_code" required> <p class="ml-1 text-small mr-4 require">住所自動入力</p>
                </div>

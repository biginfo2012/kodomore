...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body py-1">
            ...
            <div class="background-light-blue my-1">
                <p class="text-small p-1">
                    施設名
                </p>
            </div>
            <p class="mt-1 text-medium">{{$facility_name}}</p>
            ...
            <p class="mt-1 text-medium">{{$facility_name_second}}</p>
            ...
            <p class="mt-1 text-medium">{{$facility_post}}</p>
            ...
            <p class="mt-1 text-medium">{{$facility_prefecture.' '.$facility_city.' '.$facility_address}}</p>
            ...
            <p class="mt-1 text-medium">{{$facility_mobile}}</p>
            ...
            <p class="mt-1 text-medium">{{$facility_url}}</p>
        ...
        <form id="register_form" action="<?=url('/register/complete');?>" method="post">
            ...
            <input type="hidden" name="type_index" value="{{$type}}">
            <input type="hidden" name="facility_name" value="{{$facility_name}}">
            <input type="hidden" name="facility_name_second" value="{{$facility_name_second}}">
            <input type="hidden" name="facility_post" value="{{$facility_post}}">
            <input type="hidden" name="facility_address" value="{{$facility_address}}">
            <input type="hidden" name="facility_prefecture" value="{{$facility_prefecture}}">
            <input type="hidden" name="facility_city" value="{{$facility_city}}">
            <input type="hidden" name="facility_mobile" value="{{$facility_mobile}}">
            <input type="hidden" name="facility_url" value="{{$facility_url}}">
            ...
            <div class="card-body py-1">
                ...
                <div class="mt-2 flex justify-content-center">
                    <button class="background-gray mx-0 btn btn-outline-default btn-rounded waves-effect btn-full btn-title text-white " id="btn_submit">仮登録する </button><i class="text-white fas fa-angle-right ml-1"></i>
                </div>

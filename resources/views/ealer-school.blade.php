...
@section('content')
    <img src="{{asset('img/top_ealer.png')}}" class="img-fluid" alt="Responsive image" style="width: 100%;">

    <div class="card">
        <div class="card-header " style="font-weight: 800">
            <i class="fas fa-map-marker-alt "></i> 全国の小学校(00件)
        </div>

        <div class="card-body">
            <div class="form-inline d-flex justify-content-center md-form form-sm mt-0 rounded" style="border: 1px solid #cdcdcd">
                <i class="fas fa-search" aria-hidden="true"></i>
                <input class="form-control form-control-sm ml-3 w-75" type="text" placeholder="小学校名､エリア､特徴などフリーワード検索"
                       aria-label="Search">
            </div>
            <img src="{{asset('img/map_ealer.jpg')}}">
        </div>
